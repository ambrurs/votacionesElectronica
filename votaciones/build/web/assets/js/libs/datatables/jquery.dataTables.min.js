!function (t) {
    ...
    function s(t) {
        he(t, "ordering", "bSort"), he(t, "orderMulti", "bSortMulti"), he(t, "orderClasses", "bSortClasses"), he(t, "orderCellsTop", "bSortCellsTop"), he(t, "order", "aaSorting"), he(t, "orderFixed", "aaSortingFixed"), he(t, "paging", "bPaginate"), he(t, "pagingType", "sPaginationType"), he(t, "pageLength", "iDisplayLength"), he(t, "searching", "bFilter"), "boolean" == typeof t.sScrollX && (t.sScrollX = t.sScrollX ? "100%" : ""), "boolean" == typeof t.scrollX && (t.scrollX = t.scrollX ? "100%" : "");
        var e = t.aoSearchCols;
        if (e)
            for (var n = 0, a = e.length; n < a; n++)
                e[n] && o($t.models.oSearch, e[n])
    }

    function l(e) {
        he(e, "orderable", "bSortable"), he(e, "orderData", "aDataSort"), he(e, "orderSequence", "asSorting"), he(e, "orderDataType", "sortDataType");
        var n = e.aDataSort;
    ...
    function d(e, n, r) {
        ...
        var g = t.inArray("asc", i.asSorting) !== -1,
                b = t.inArray("desc", i.asSorting) !== -1;
    ...
    function T(t, e, n, r) {
        ...
        if (u === a)
            return t.iDrawError != o && null === l && (Rt(t, 0, "Requested unknown parameter " + ("function" == typeof i.mData ? "{function}" : "'" + i.mData + "'") + " for row " + e + ", column " + n, 4), t.iDrawError = o), l;
        ...
        var r = function (e, n, o) {
            ...
            if ("" !== o)
                for (var c = x(o), f = 0, d = c.length; f < d; f++) {
                    if (i = c[f].match(pe), s = c[f].match(ge), i) {
                        if (c[f] = c[f].replace(pe, ""), "" !== c[f] && (e = e[c[f]]), l = [], c.splice(0, f + 1), u = c.join("."), t.isArray(e))
    ...
    function A(e) {
        ...
        var n = function (e, r, o) {
            for (var i, s, l, u, c, f = x(o), d = f[f.length - 1], h = 0, p = f.length - 1; h < p; h++) {
                if (s = f[h].match(pe), l = f[h].match(ge), s) {
                    if (f[h] = f[h].replace(pe, ""), e[f[h]] = [], i = f.slice(), i.splice(0, h + 1), c = i.join("."), t.isArray(r))
                ...
                l && (f[h] = f[h].replace(ge, ""), e = e[f[h]](r)), null !== e[f[h]] && e[f[h]] !== a || (e[f[h]] = {}), e = e[f[h]]
            }
            d.match(ge) ? e = e[d.replace(ge, "")](r) : e[d.replace(pe, "")] = r
        };
        return function (t, a) {
            return n(t, a, e)
        }
    ...
    function H(e, a, r, o) {
        var i, s, l, u, c, f = e.aoData[a],
                ...
                h = [];
        if (null === f.nTr) {
            for (i = r || n.createElement("tr"), f.nTr = i, f.anCells = h, i._DT_RowIndex = a, N(e, f), u = 0, c = e.aoColumns.length; u < c; u++)
                l = e.aoColumns[u], s = r ? o[u] : n.createElement(l.sCellType), s._DT_CellIndex = {
                    row: a,
                    column: u
    ...
    function N(e, n) {
        ...
        if (a) {
            ...
            if (o && (a.id = o), r.DT_RowClass) {
                ...
                n.__rowc = n.__rowc ? de(n.__rowc.concat(i)) : i, t(a).removeClass(n.__rowc.join(" ")).addClass(r.DT_RowClass)
            }
    ...
    function O(e) {
        ...
        for (u && (o = t("<tr/>").appendTo(s)), n = 0, a = f.length; n < a; n++)
            i = f[n], r = t(i.nTh).addClass(i.sClass), u && r.appendTo(o), e.oFeatures.bSort && (r.addClass(i.sSortingClass), i.bSortable !== !1 && (r.attr("tabindex", e.iTabIndex).attr("aria-controls", e.sTableId), xt(e, i.nTh, n))), i.sTitle != r[0].innerHTML && r.html(i.sTitle), Wt(e, "header")(e, r, i, c);
    ...
    function M(e) {
        ...
        var d = e._iDisplayStart,
                h = e.fnDisplayEnd();
        if (e.bDeferLoading)
            e.bDeferLoading = !1, e.iDraw++, ht(e, !1);
        else if (c) {
    ...
    function J(e, n, a) {
        ...
        var f = {
            ...
            error: function (n, a, r) {
                var o = kt(e, null, "xhr", [e, null, e.jqXHR]);
                t.inArray(!0, o) === -1 && ("parsererror" == a ? Rt(e, 0, "Invalid JSON response", 1) : 4 === n.readyState && Rt(e, 0, "Ajax error", 7)), ht(e, !1)
            }
        };
    ...
    function X(e) {
        ...
        g("sEcho", e.iDraw), g("iColumns", s), g("sColumns", se(i, "sName").join(",")), g("iDisplayStart", h), g("iDisplayLength", p);
        var b = {
            draw: e.iDraw,
            columns: [],
            order: [],
        ...
        for (n = 0; n < s; n++)
            r = i[n], o = c[n], a = "function" == typeof r.mData ? "function" : r.mData, b.columns.push({
                data: a,
                name: r.sName,
    ...
    function $(e) {
        ...
        var c = t("<div/>", {
            ...
            class: a.sFilter
                ...
                h = t("input", c).val(i.sSearch).attr("placeholder", o.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", d ? De(f, d) : f).on("keypress.DT", function (t) {
            if (13 == t.keyCode)
                return !1
    ...
    function Z(t, e, n, a, r, o) {
        if ("" !== e) {
            for (var i, s = [], l = t.aiDisplay, u = K(e, a, r, o), c = 0; c < l.length; c++)
    ...
    function Q(t, e, n, a, r, o) {
        var i, s, l, u = K(e, a, r, o),
                ...
                f = t.aiDisplayMaster,
                d = [];
        if (0 !== $t.ext.search.length && (n = !0), s = tt(t), e.length <= 0)
            t.aiDisplay = f.slice();
        else {
            for ((s || n || c.length > e.length || 0 !== e.indexOf(c) || t.bSorted) && (t.aiDisplay = f.slice()), i = t.aiDisplay, l = 0; l < i.length; l++)
                u.test(t.aoData[i[l]]._sFilterRow) && d.push(i[l]);
            t.aiDisplay = d
        }
    }
        ...
        for (n = 0, r = t.aoData.length; n < r; n++)
            if (l = t.aoData[n], !l._aFilterData) {
                for (i = [], a = 0, o = u.length; a < o; a++)
                    e = u[a], e.bSearchable ? (s = T(t, n, a, "filter"), c[e.sType] && (s = c[e.sType](s)), null === s && (s = ""), "string" != typeof s && s.toString && (s = s.toString())) : s = "", s.indexOf && s.indexOf("&") !== -1 && (ve.innerHTML = s, s = Se ? ve.textContent : ve.innerText), s.replace && (s = s.replace(/[\r\n]/g, "")), i.push(s);
    ...
    function it(t) {
        ...
        for (U(t), O(t), k(t, t.aoHeader), k(t, t.aoFooter), ht(t, !0), i.bAutoWidth && vt(t), e = 0, n = o.length; e < n; e++)
            a = o[e], a.sWidth && (a.nTh.style.width = yt(a.sWidth));
    ...
    function ut(e) {
        ...
        return e.aanFeatures.l || (f[0].id = a + "_length"), f.children().append(e.oLanguage.sLengthMenu.replace("_MENU_", l[0].outerHTML)), t("select", f).val(e._iDisplayLength).on("change.DT", function (n) {
            lt(e, t(this).val()), M(e)
            ...
            fn: function (t) {
                if (r) {
                    ...
                    for (e = 0, n = s.p.length; e < n; e++)
                        Wt(t, "pageButton")(t, s.p[e], e, h, f, d)
                } else
                    a.fnUpdate(t, o)
            },
            sName: "pagination"
    ...
    function ft(t, e, n) {
        var a = t._iDisplayStart,
                r = t._iDisplayLength,
                o = t.fnRecordsDisplay();
        0 === o || r === -1 ? a = 0 : "number" == typeof e ? (a = e * r, a > o && (a = 0)) : "first" == e ? a = 0 : "previous" == e ? (a = r >= 0 ? a - r : 0, a < 0 && (a = 0)) : "next" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : Rt(t, 0, "Unknown paging action: " + e, 5);
    ...
    function gt(e) {
        ...
        if (e.scrollBarVis !== V && e.scrollBarVis !== a)
            return e.scrollBarVis = V, void h(e);
        e.scrollBarVis = V, P.children("thead, tfoot").remove(), H && (l = H.clone().prependTo(P), r = H.find("tr"), i = l.find("tr")), s = L.clone().prependTo(P), n = L.find("tr"), o = s.find("tr"), s.find("th, td").removeAttr("tabindex"), g || (x.width = "100%", m[0].style.width = "100%"), t.each(E(e, s), function (t, n) {
            ...
            t.inArray(e, k) !== -1 && (e.style.width = M[n])
    ...
    function vt(n) {
        ...
        for (T && T.indexOf("%") !== - 1 && (m = T), a = 0; a < g.length; a++)
            r = s[g[a]], null !== r.sWidth && (r.sWidth = St(r.sWidthOrig, D), y = !0);
        if (C || !y && !c && !u && d == b(n) && d == S.length)
            ...
            for (x.find("thead, tfoot").remove(), x.append(t(n.nTHead).clone()).append(t(n.nTFoot).clone()), x.find("tfoot th, tfoot td").css("width", ""), S = E(n, x.find("thead")[0]), a = 0; a < g.length; a++)
                r = s[g[a]], S[a].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? yt(r.sWidthOrig) : "", r.sWidthOrig && c && t(S[a]).append(t("<div/>").css({
                    width: r.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            if (n.aoData.length)
                for (a = 0; a < g.length; a++)
                    o = g[a], r = s[o], t(mt(n, o)).clone(!1).append(r.sContentPadding).appendTo(I);
        ...
        if (m && (i.style.width = yt(m)), (m || c) && !n._reszEvt) {
            var j = function () {
                t(e).on("resize.DT-" + n.sInstance, De(function () {
                    h(n)
                }))
            };
    ...
    function Dt(t, e) {
        for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
            n = T(t, o, e, "display") + "", n = n.replace(me, ""), n = n.replace(/&nbsp;/g, " "), n.length > a && (a = n.length, r = o);
        return r
    }
    ...
    function _t(e) {
        ...
        for (t.isArray(d) && g(d), h && d.pre && g(d.pre), g(e.aaSorting), h && d.post && g(d.post), n = 0; n < p.length; n++)
            for (u = p[n][0], i = f[u].aDataSort, r = 0, o = i.length; r < o; r++)
                s = i[r], l = f[s].sType || "string", p[n]._idx === a && (p[n]._idx = t.inArray(p[n][1], f[s].asSorting)), c.push({
                    src: u,
                    col: s,
                    dir: p[n][1],
                    index: p[n]._idx,
    ...
    function Ct(t) {
        var e, n, a, r, o, i = [],
                ...
                u = (t.aoColumns, 0),
                c = t.aiDisplayMaster;
        for (S(t), o = _t(t), e = 0, n = o.length; e < n; e++)
            r = o[e], r.formatter && u++, At(t, r.col);
        if ("ssp" != Ut(t) && 0 !== o.length) {
            ...
            u === o.length ? c.sort(function (t, e) {
                ...
                for (r = 0; r < c; r++)
                    if (u = o[r],
                            n = f[u.col], a = d[u.col], s = n < a ? -1 : n > a ? 1 : 0, 0 !== s)
    ...
    function It(e) {
        ...
        if (l.bSort && l.bSortClasses) {
            for (n = 0, a = o.length; n < a; n++)
                r = o[n].src, t(se(e.aoData, "anCells", r)).removeClass(i + (n < 2 ? n + 1 : 3));
            for (n = 0, a = s.length; n < a; n++)
                r = s[n].src, t(se(e.aoData, "anCells", r)).addClass(i + (n < 2 ? n + 1 : 3))
        }
        e.aLastSort = s
    }
    ...
    function At(t, e) {
        ...
        for (var o, i, s = $t.ext.type.order[a.sType + "-pre"], l = 0, u = t.aoData.length; l < u; l++)
    ...
    function Lt(e, n, r) {
        var o, i, s = e.aoColumns,
                l = function (n) {
                    if (!n || !n.time)
                        return void r();
                    var l = kt(e, "aoStateLoadParams", "stateLoadParams", [e, u]);
                    if (t.inArray(!1, l) !== -1)
                        return void r();
                    var c = e.iStateDuration;
                    if (c > 0 && n.time < +new Date - 1e3 * c)
                        return void r();
                    if (n.columns && s.length !== n.columns.length)
                        return void r();
                    if (e.oLoadedState = t.extend(!0, {}, u), n.start !== a && (e._iDisplayStart = n.start, e.iInitDisplayStart = n.start), n.length !== a && (e._iDisplayLength = n.length), n.order !== a && (e.aaSorting = [], t.each(n.order, function (t, n) {
                        e.aaSorting.push(n[0] >= s.length ? [0, n[1]] : n)
                    })), n.search !== a && t.extend(e.oPreviousSearch, nt(n.search)), n.columns)
                        for (o = 0, i = n.columns.length; o < i; o++) {
                            var f = n.columns[o];
                            f.visible !== a && (s[o].bVisible = f.visible), f.search !== a && t.extend(e.aoPreSearchCols[o], nt(f.search))
                        }
                    kt(e, "aoStateLoaded", "stateLoaded", [e, u]), r()
                };
    ...
    function Rt(t, n, a, r) {
        if (a = "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + a, r && (a += ". For more information about this error, please see http://datatables.net/tn/" + r), n)
            ...
            if (t && kt(t, null, "error", [t, r, a]), "alert" == i)
                alert(a);
            else {
                if ("throw" == i)
                    throw new Error(a);
    ...
    function Bt(t, e) {
        var n = [],
                a = Je.numbers_length,
                r = Math.floor(a / 2);
        return e <= a ? n = ue(0, e) : t <= r ? (n = ue(0, a - 2), n.push("ellipsis"), n.push(e - 1)) : t >= e - 1 - r ? (n = ue(e - (a - 2), e), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)) : (n = ue(t - r + 2, t + r - 1), n.push("ellipsis"), n.push(e - 1), n.splice(0, 0, "ellipsis"), n.splice(0, 0, 0)), n.DT_el = "span", n
    }
    ...
    var Vt, Xt, qt, Gt, $t = function (e) {
        ...
        return this.each(function () {
            ...
            if ("table" != this.nodeName.toLowerCase())
                return void Rt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
            ...
            var j = F.asStripeClasses,
                    H = C.children("tbody").find("tr").eq(0);
                    ...
                    U = function () {
                        if (g.aaSorting === a) {
                            ...
                            for (b = 0, h = e.length; b < h; b++)
                                e[b][1] = F.aoColumns[b].asSorting[0]
                        }
                        ...
                        if (0 === i.length && n.length > 0 && ("" !== F.oScroll.sX || "" !== F.oScroll.sY) && (i = t("<tfoot/>").appendTo(C)), 0 === i.length || 0 === i.children().length ? C.addClass(L.sNoFooter) : i.length > 0 && (F.nTFoot = i[0], B(F.aoFooter, F.nTFoot)), g.aaData)
                            for (b = 0; b < g.aaData.length; b++)
                                D(F, g.aaData[b]);
                        else
                            (F.bDeferLoading || "dom" == Ut(F)) && y(F, t(F.nTBody).children("tr"));
                        F.aiDisplay = F.aiDisplayMaster.slice(), F.bInitialised = !0, S === !1 && it(F)
                    };
            g.bStateSave ? (W.bStateSave = !0, Ot(F, "aoDrawCallback", Ft, "state_save"), Lt(F, g, U)) : U()
        }), n = null, this
    },
            zt = {},
            Yt = /[\r\n]/g,
            ...
            ae = function (t, e) {
                return zt[e] || (zt[e] = new RegExp(be(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(zt[e], ".") : t
            },
            re = function (t, e, n) {
                var a = "string" == typeof t;
                return !!ee(t) || (e && a && (t = ae(t, e)), n && a && (t = t.replace(te, "")), !isNaN(parseFloat(t)) && isFinite(t))
            },
            oe = function (t) {
            ...
            ie = function (t, e, n) {
                if (ee(t))
                    return !0;
                var a = oe(t);
                return a ? !!re(fe(t), e, n) || null : null
            },
            se = function (t, e, n) {
                var r = [],
                        o = 0,
    ...
    Xt = function (e, n) {
        ...
        if (t.isArray(e))
            ...
            r(e);
        this.context = de(a), n && t.merge(this, n), this.selector = {
            rows: null,
            cols: null,
            opts: null
        }, Xt.extend(this, this, ye)
        ...
        iterator: function (t, e, n, r) {
            ...
            for ("string" == typeof t && (r = n, n = e, e = t, t = !1), i = 0, s = p.length; i < s; i++) {
                ...
                if ("table" === e)
                    ...
                    for (f = this[i], "column-rows" === e && (c = Fe(p[i], g.opts)), l = 0, u = f.length; l < u; l++)
        ...
        unique: function () {
            return new Xt(this.context, de(this))
        },
        unshift: _e.unshift
        ...
        if (a.length && n && (n instanceof Xt || n.__dt_wrapper)) {
            ...
            for (r = 0, o = a.length; r < o; r++)
                i = a[r], n[i.name] = "function" == typeof i.val ? s(e, i.val, i) : t.isPlainObject(i.val) ? {} : i.val, n[i.name].__dt_wrapper = !0, Xt.extend(e, n[i.name], i.propExt)
        }
    ...
    qt("tables()", function (t) {
        return t ? new Xt(Te(t, this.context)) : this
    }), qt("table()", function (t) {
        var e = this.tables(t),
                n = e.context;
    ...
    var xe = function (e, n, r, o, i) {
        var s, l, u, c, f, d, h = [],
                p = typeof n;
        for (n && "string" !== p && "function" !== p && n.length !== a || (n = [n]), u = 0, c = n.length; u < c; u++)
            for (l = n[u] && n[u].split && !n[u].match(/[\[\(:]/) ? n[u].split(",") : [n[u]], f = 0, d = l.length; f < d; f++)
        ...
        return de(h)
            ...
            Fe = function (e, n) {
                var a, r, o, i = [],
                        ...
                        f = n.page;
                if ("ssp" == Ut(e))
                    return "removed" === u ? [] : ue(0, l.length);
                if ("current" == f)
            ...
            Le = function (e, n, r) {
                var o, i = function (n) {
                    ...
                    if (null !== i && !r)
                        return [i];
                    if (o || (o = Fe(e, r)), null !== i && t.inArray(i, o) !== -1)
                        return [i];
                    if (null === n || n === a || "" === n)
                        return o;
                    ...
                    var s = ce(le(e.aoData, o, "nTr"));
                    if (n.nodeName) {
                        if (n._DT_RowIndex !== a)
                            return [n._DT_RowIndex];
                        if (n._DT_CellIndex)
                            return [n._DT_CellIndex.row];
                ...
                return xe("row", n, i, e, r)
            };
    qt("rows()", function (e, n) {
        e === a ? e = "" : t.isPlainObject(e) && (n = e, e = ""), n = Ie(n);
        ...
        i(a, r), n._details && n._details.detach(), n._details = t(o), n._detailsShow && n._details.insertAfter(n.nTr)
            ...
            He = function (t) {
                var e = new Xt(t),
                        ...
                        o = "destroy" + n,
                        i = t.aoData;
                e.off(a + " " + r + " " + o), se(i, "_details").length > 0 && (e.on(a, function (n, a) {
                    t === a && e.rows({
                        page: "current"
    ...
    qt(ke, function (t, e) {
        var n = this.context;
        return t === a ? n.length && this.length ? n[0].aoData[this[0]]._details : a : (t === !0 ? this.child.show() : t === !1 ? Re(this) : n.length && this.length && Pe(n[0], n[0].aoData[this[0]], t, e), this)
    }), qt([Oe + ".show()", ke + ".show()"], function (t) {
        return je(this, !0), this
    }), qt([Oe + ".hide()", ke + ".hide()"], function () {
        return je(this, !1), this
    }), qt([Oe + ".remove()", ke + ".remove()"], function () {
        return Re(this), this
    }), qt(Oe + ".isShown()", function () {
        var t = this.context;
        return !(!t.length || !this.length) && (t[0].aoData[this[0]]._detailsShow || !1)
    });
    var Me = /^([^:]+):(name|visIdx|visible)$/,
            We = function (t, e, n, a, r) {
                        ...
                        s = function (n) {
                            ...
                            if ("function" == typeof n) {
                                ...
                                return t.map(r, function (t, a) {
                                    return n(a, We(e, a, 0, 0, l), i[a]) ? a : null
                                })
                            }
                            ...
                            if (d.length || !n.nodeName)
                                return d;
                            var h = t(n).closest("*[data-dt-column]");
                            return h.length ? [h.data("dt-column")] : []
                        };
                return xe("column", n, s, e, a)
            },
            Be = function (e, n, r) {
    ...
    qt("columns()", function (e, n) {
        ...
        var n = this.iterator("column", function (e, n) {
            return t === a ? e.aoColumns[n].bVisible : void Be(e, n, t)
        });
    ...
    qt("cells()", function (e, n, r) {
        ...
        var n = t(e).get(0),
                a = !1;
        return e instanceof $t.Api || (t.each($t.settings, function (e, r) {
        ...
        return n = n || !1, this.iterator("table", function (a) {
            ...
            var b = t.inArray(a, $t.settings);
            b !== -1 && $t.settings.splice(b, 1)
        })
        ...
        oLanguage: {
            oAria: {
                ...
                sSortDescending: ": activar para ordernar la columna descendente"
            },
            oPaginate: {
                sFirst: "Primero",
                sLast: "Último",
    ...
    t.extend(Je, {
        ...
        pageButton: {
            _: function (e, r, o, i, s, l) {
                var u, c, f, d = e.oClasses,
                        ...
                        g = 0,
                        b = function (n, a) {
                            var r, i, f, v, S = function (t) {
                                ft(e, t.data.action, !0)
                            };
                            for (r = 0, i = a.length; r < i; r++)
                                if (v = a[r], t.isArray(v)) {
            ...
            if (t && !(t instanceof Date) && !Qt.test(t))
                return null;
            var n = Date.parse(t);
        ...
        html: function (t) {
            return ee(t) ? t : "string" == typeof t ? t.replace(Yt, " ").replace(Zt, "") : ""
        },
        string: function (t) {
    ...
    var Ve = function (t, e, n, a) {
        return 0 === t || t && "-" !== t ? (e && (t = ae(t, e)), t.replace && (n && (t = t.replace(n, "")), a && (t = t.replace(a, ""))), 1 * t) : -(1 / 0)
    };
