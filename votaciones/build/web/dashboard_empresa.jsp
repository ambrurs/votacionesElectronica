                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item nav-dropdown">
                            ...
                            <ul class="nav-dropdown-items">
                                <li class="nav-item">
                                    <a class="nav-link" href="#tipovotaciones"><i class="icon-puzzle"></i> Tipo de votaciones</a>
                                </li>
                                <!--                                <li class="nav-item">
                                                                    <a class="nav-link" href="#tipoestadosvotacion"><i class="icon-puzzle"></i> Tipo estado votaciones</a>
                                                                </li>                                -->
                            </ul>
                        </li>                                                
                        <li class="nav-item">
                            <a class="nav-link" href="#votaciones"><i class="icon-check"></i> Votaciones</a>
                        </li>
                    </ul>
                </nav>
            </div>
