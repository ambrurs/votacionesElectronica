...
<div class="animated fadeIn">
    <div class="card">
        ...
        <div class="card-block">            
            ...
            <hr/>
            <form id="formTipoEstadoVotaciones">
                <input type="hidden" id="idTipoEstadoVotacion" name="idTipoEstadoVotacion" />
                <div class="row">
                    <div class="col-md-4">         
                        <div class="form-group">
                            <label for="txtNombreDocumento">Nombre Estado</label>
                            <input type="text" class="form-control" id="txtNombreEstado" name="nombreEstado" required="">
                        </div>
                    </div>                    
                    <div class="col-md-4">
            ...
            <hr/>
            <table id="tablaTipoEstadosVotacion" class="table table-striped table-bordered" width="100%"></table>
        </div>
    </div>
</div>
<script src="../assets/js/views/dashboard/admin/tipoestadovotacion.js" type="text/javascript"></script>